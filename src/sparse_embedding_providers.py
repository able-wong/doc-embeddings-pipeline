    ...
    def generate_sparse_embedding(self, text: str) -> Dict[str, List[int]]:
        ...
        try:
            ...
            with torch.no_grad():
                ...
                self.logger.debug(f"Generated sparse vector: {len(non_zero_indices)} non-zero dimensions")
...
def create_sparse_embedding_provider(config: SparseEmbeddingConfig) -> SparseEmbeddingProvider:
